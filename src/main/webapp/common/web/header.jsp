		...
		<div class="container">
			...
			<div class="ht-right">
				...
				<security:authorize access="isAnonymous()">
					<a href="<c:url value='/dang-ki'/>" class="login-panel">Sign up</a>
					<a href="<c:url value='/dang-nhap'/>" class="login-panel"><i
						class="fa fa-user"></i>Login</a>
				</security:authorize>
				<security:authorize access="isAuthenticated()">
					<a href="<c:url value='/thoat'/>" class="login-panel">Logout</a>
					<a href="#" class="login-panel"><i class="fa fa-user"></i>Wellcome
		...
		<div class="inner-header">
			<div class="row">
				<div class="col-lg-2 col-md-2">
					<div class="logo">
						<a href='<c:url value="/trang-chu?page=1&limit=6"/>'> <img
				...
				<div class="col-lg-7 col-md-7">
					<div class="advanced-search">
						...
						<form action="<c:url value='/trang-chu/search'/>"
							class="input-group">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="breadcrumb-text product-more">
						<a href="<c:url value="/trang-chu?page=1&limit=6"/>"><i
							class="fa fa-home"></i> Home</a> <a href="./shop.html">Shop</a> <span>Detail</span>
					</div>
				</div>
			</div>
		</div>
