...
<body>
	<div class="main-content">
		<form class="form-search"
			action="<c:url value='/quan-tri/clothes/search'/>">
		...
		<form action="<c:url value='/quan-tri/clothes/danh-sach'/>" id="formSubmit" method="get">
									...
									<div class="pull-right tableTools-container">
										<div class="dt-buttons btn-overlap btn-group">
											...
											<a flag="info"
												...
												data-toggle="tooltip" title='Thêm sản phẩm' href='${createClothesURL}'> <span>
												...
												<c:forEach var="item" items="${model.listResult}">
													<tr>
														...
														<td>${item.categoryCode}</td>
															<c:url var="updateClothesURL" value="/quan-tri/clothes/chinh-sua">
																<c:param name="id" value="${item.id}"/>
															</c:url>
														<td>
															<a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip" title="Cập nhật sản phẩm" href='${updateClothesURL}'><i
